...
public final class ByteStringMicro {
    ...
    private ByteStringMicro(byte[] bytes2) {
        this.bytes = bytes2;
    }
    ...
    public static ByteStringMicro copyFrom(byte[] bytes2, int offset, int size) {
        byte[] copy = new byte[size];
        System.arraycopy(bytes2, offset, copy, 0, size);
        return new ByteStringMicro(copy);
    }

    public static ByteStringMicro copyFrom(byte[] bytes2) {
