...
public final class CodedOutputStreamMicro {
    ...
    private CodedOutputStreamMicro(byte[] buffer2, int offset, int length) {
        this.output = null;
        this.buffer = buffer2;
    ...
    private CodedOutputStreamMicro(OutputStream output2, byte[] buffer2) {
        this.output = output2;
        this.buffer = buffer2;
        this.position = 0;
    ...
    public static CodedOutputStreamMicro newInstance(OutputStream output2) {
        return newInstance(output2, DEFAULT_BUFFER_SIZE);
    }

    public static CodedOutputStreamMicro newInstance(OutputStream output2, int bufferSize) {
        return new CodedOutputStreamMicro(output2, new byte[bufferSize]);
    }
    ...
    public void writeRawVarint32(int value) throws IOException {
        while ((value & -128) != 0) {
            writeRawByte((value & 127) | AndsfConstant.MAX_THRESHOLDS_ID);
            value >>>= 7;
        }
        writeRawByte(value);
    }
    ...
    public void writeRawVarint64(long value) throws IOException {
        while ((-128 & value) != 0) {
            writeRawByte((((int) value) & 127) | AndsfConstant.MAX_THRESHOLDS_ID);
            value >>>= 7;
        }
